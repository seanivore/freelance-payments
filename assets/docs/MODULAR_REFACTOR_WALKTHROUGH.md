...
```json
{
  ...
  "client": {
    "name": "Everlastings by Emy",
    "last_name": "Everlastings",
    "contact": {
      "name": "Emy Johnson",
      "title": "Owner",
      "email": "emy@everlastings.com",
      "phone": "+1-555-0123"
    },
    "address": {
  ...
  "product": {
    ...
    "description": "Custom website redesign with e-commerce integration",
    "metadata": {
  ...
  "project_scope_summary": "Website redesign with e-commerce",
  "project_scope_full": "Complete website redesign including new branding, product catalog, shopping cart, and payment integration."
}
```
